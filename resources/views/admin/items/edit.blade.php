    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
             ...
             <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('parents', 'Родительское меню', ['class' => 'control-label']) !!}
                    {!! Form::select('parents', $menuses, old('parents') ? old('parents') : $item->parents->pluck('id')->toArray(), ['class' => 'form-control select2']) !!}
                    <p class="help-block"></p>

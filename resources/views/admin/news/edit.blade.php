...
@section('content')
    ...
    {!! Form::model($news, ['method' => 'PUT', 'route' => ['admin.news.update', $news->id], 'files' => true,]) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('short', 'Коротко', ['class' => 'control-label']) !!}
                    {!! Form::text('short', old('short'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('short'))
                        <p class="help-block">
                            {{ $errors->first('short') }}
                ...
                <div class="col-xs-12 form-group">
                    ...
                    <div class="photo-block">
                        ...
                        <div class="files-list">
                            @foreach($news->getMedia('photos') as $media)
                                <p class="form-group">
